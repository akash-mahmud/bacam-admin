...
import { CustomProductStatus, ProductType, useCategoriesQuery, useUploadFileMutation } from '@/graphql/generated/schema'
                    ...
                    >
                        <Spin spinning={loadingUpload}>
                            ...
                            <UploadSingleImage uploadButton={uploadButton} filelist={
                                ...
                                files}
                                handlePreview={handlePreview} beforeUpload={handleBeforeUploadUpdate} handleRemove={(file) => {
                                    const removedImageArrayForShow = files?.filter((fileData) => fileData.url !== file.url)
                                    const databaseInput = formik.values.images
                                    const removedImageArrayForDatabase = databaseInput?.filter((fileData: string) => getImage(fileData) !== file.url)
